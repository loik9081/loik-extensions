...
export async function getCategoryData(categoryId: string, page: number, requestManager: RequestManager, cheerio: CheerioAPI): Promise<[MangaTile[], boolean]> {
    ...
    for (const manga of searchResults) results.push(createMangaTile({
